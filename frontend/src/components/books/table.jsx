...
const BookTable = ({
  ...
  <table className="table tw-w-full tw-text-sm tw-text-left rtl:tw-text-right  dark:tw-text-gray-400 tw-border-none">
    <caption className="tw-text-gray-500 tw-text-sm tw-mb-4">
      List of Books
    </caption>
