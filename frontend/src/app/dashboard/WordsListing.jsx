                ...
                <TableBody>
                  {knownWords.length > 0 ? (
                    ...
                    <TableRow className="mt-3 text-right text-gray-700 dark:text-gray-300 font-medium">
                      <TableCell className="text-center" colSpan={2}>No known words</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
              ...
              <Table>
                ...
                <TableBody>
                  {unknownWords.length > 0 ? (
                    ...
                    <TableRow className="mt-3  text-gray-700 dark:text-gray-300 font-medium">
                      <TableCell className="text-center" colSpan={2}>No unknown words</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
