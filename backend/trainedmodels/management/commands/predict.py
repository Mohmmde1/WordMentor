...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--book-path", type=str, required=True, help="Path to the PDF book"
        )
        parser.add_argument(
            "--from-page", type=int, required=True, help="Starting page number"
        )
        parser.add_argument(
            "--to-page", type=int, required=True, help="Ending page number"
        )
    ...
    def handle(self, *args, **options):
        ...
        try:
            tokenizer_cache = os.path.join(
                settings.BASE_DIR, "data", "cache_dir", "tokenizer"
            )
